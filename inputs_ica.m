...
icasso_opts.max_cluster_size = 50; % Max cluster size. Max is the no. of components
...
% input_data_file_patterns = {'/home/labuser/Projects/Yikang/stepoch/nii_images_reg_al_sm_motionregression_detrend/Rat1/*nii'};
% for i = 2:71
%     input_data_file_patterns{i,1} = ['/home/labuser/Projects/Yikang/stepoch/nii_images_reg_al_sm_motionregression_detrend/Rat',num2str(i),'/*nii'];
% end
input_data_file_patterns = {'/home/yliu/projects/organize_database/ica/data_4clean/rat001_02_despiked_registered_aligned.nii'};
...
%     scan_list = dir(fullfile(data_dir, rat_list(i).name, 'rfmri_intermediate', '*aligned.nii'));
%     for j = 1:length(scan_list)
% %         if isempty(strfind(scan_list(j).name, 'despiked'))
% copyfile(fullfile(scan_list(j).));
%             input_data_file_patterns(end+1,1) = {fullfile(scan_list(j).folder, scan_list(j).name)};
% %          end
%     end
% end
...
outputDir = '/home/yliu/projects/organize_database/ica/indi_clean_wmmask/tmp';
...
refFiles = {'D:\rat database\ica\ica_50_15\ic_1.img', ...
    'D:\rat database\ica\ica_50_15\ic_2.img', ...
    'D:\rat database\ica\ica_50_15\ic_3.img', ...
    'D:\rat database\ica\ica_50_15\ic_4.img', ...
    'D:\rat database\ica\ica_50_15\ic_5.img', ...
    'D:\rat database\ica\ica_50_15\ic_6.img', ...
    'D:\rat database\ica\ica_50_15\ic_7.img', ...
    'D:\rat database\ica\ica_50_15\ic_8.img', ...
    'D:\rat database\ica\ica_50_15\ic_9.img', ...
    'D:\rat database\ica\ica_50_15\ic_10.img', ...
    'D:\rat database\ica\ica_50_15\ic_11.img', ...
    'D:\rat database\ica\ica_50_15\ic_12.img', ...
    'D:\rat database\ica\ica_50_15\ic_13.img', ...
    'D:\rat database\ica\ica_50_15\ic_14.img', ...
    'D:\rat database\ica\ica_50_15\ic_15.img', ...
    };
